...
function App() {
  ...
  const handleLogin = () => {
    window.location.href = 'https://ap-south-1squnbxjqf.auth.ap-south-1.amazoncognito.com/login?client_id=3h790bho4eq9je3ofgeuih854b&response_type=code&scope=email+openid+phone&redirect_uri=https://staging.d3bsnga2fhi5b6.amplifyapp.com/callback';
  };
